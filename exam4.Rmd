...
It can also be seen that all the variables except educaation are statistically significant at a 5% significance level due to p-vaalues < 0.05. All variables except education are also significant at a 1% significance level.
