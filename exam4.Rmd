...
PCP
```
It can be seen that the three models are almost equally good at predicting. The logit and probit models only predict marginally better at 68.12%, while the LPM corretly predicts 67.43%. 
=======
...
>>>>>>> a4b7aac03b1b7cbdff99d9cb702e0d0604a3866b
