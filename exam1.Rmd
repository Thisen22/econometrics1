...
where $R^2_{ur}$ is the R-squared from our unrestricted model, $R^2_{r}$ is the R-squared from the restricted and q is the difference in the degrees of freedom between the unrestricted and restricted model.
