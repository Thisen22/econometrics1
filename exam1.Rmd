...
The residuals vs leverage plot helps detect outliers in the model. SKRIV FÆRDIG.
...
where $SSR_r$ is the sum of squared residuals from our unrestricted model, $SSR_{ur}$ is the sum of squared residuals from the restricted and q is the difference in the degrees of freedom between the unrestricted and restricted model.
